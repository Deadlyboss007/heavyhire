...
<body>
    ...
    <form class="flex flex-col px-20 py-20" method="POST">
        <input value="abhinav@gmail.com" class="border-2 mb-10 py-3 rounded-[15px] px-5" type="email" placeholder="Enter email" name="email">
        <input value="abhinav" class="border-2 mb-10 py-3 rounded-[15px] px-5" type="password" name="pass" placeholder="Enter password" id="">
